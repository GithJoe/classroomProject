...
<br><br>
    <main>
	    <s:form action="classroom/classroom_queryClassrooms" method="post">
	      
	      <div>
	         <s:submit value="查 询" cssClass="search-go"></s:submit>

	         <input class="search" type="text" name="keyWords" placeholder="请输入所查询教室的关键词">
	      </div>

<br>
	
	      <table  align="center" class="altrowstable" id="alternatecolormain">
	          <br><br><br>
	        <tr>  
	          <th style="width:150px;">自习室序号</th>  
	          <th style="width:150px;">自习室名称</th>
	          <th style="width:150px;">空闲时间</th> 
	          <th style="width:150px;">操作</th>  
	          
	        </tr> 
	        <c:forEach var="classroom" items="${classroomList}" varStatus="status">
	          <tr>
	            <td style="width:150px;"><c:out value="${status.index+1}"></c:out></td>
	            <td style="width:150px;"><a href="classroom/classroom_showDetail?classroom.classroomid=${classroom.classroomid}">
	            <c:out value="${classroom.classroomname}"></c:out></a></td>
	            <td style="width:150px;"><c:out value="${classroom.emptytime}"></c:out></td>
	            
	            
	            <td style="width:150px;">
	            <a href="reservation/reservation_addReservation?classroom.classroomid=${classroom.classroomid}&user.username=${user.username}">占个座儿</a></td>
	          </tr>
	        </c:forEach>
	      </table>
	    </s:form>
